...
# Code taken from https://github.com/andrewbeattycourseware/dataRepresenation2020
...
# create
# curl -X POST -d "{\"employee_ID\":\"125\", \"employee_Name\":\"Richard\", \"employee_Dept_ID\": 155,\"employee_Salary\":400.00}" -H "Content-Type:application/json" http://127.0.0.1:5000/employee
# curl http://127.0.0.1:5000/employee
